...
5. </br> Project cooeprated with University of Chicago Booth School of Business, developed fine-tuned and optimazed LLM to generate business-domain embeddings enriched with broad general knowledge—enabling the extraction of CEO-level actionable insights in management, financial decision-making. 
